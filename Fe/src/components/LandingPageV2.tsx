      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-lg text-gray-600">
              Cerita sukses dari mahasiswa yang sudah merasakan manfaatnya
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white border border-gray-100 rounded-2xl p-8">
              <div className="flex gap-1 mb-4">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} size={16} className="text-amber-500" weight="fill" />
                ))}
              </div>
              <p className="text-gray-700 mb-5">
                "Dulu sering kehabisan uang di tengah bulan, sekarang malah bisa nabung 500rb per bulan. AI-nya bener-bener helpful!"
              </p>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-semibold text-gray-900">Sarah Rahmawati</div>
                  <div className="text-sm text-gray-600">Mahasiswa UI</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-8">
              ...
              <p className="text-gray-700 mb-5">
                "Fitur AI insights-nya keren banget! Dia tau persis dimana aku boros dan kasih saran yang masuk akal."
              </p>
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center text-white font-semibold">
                  DF
                ...
                <div>
                  <div className="font-semibold text-gray-900">Dimas Firmansyah</div>
                  <div className="text-sm text-gray-600">Mahasiswa ITB</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-8">
              ...
              <p className="text-gray-700 mb-5">
                "Akhirnya bisa kontrol pengeluaran delivery food. Sekarang lebih sering masak sendiri dan hemat banyak!"
              </p>
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center text-white font-semibold">
                  AN
                ...
                <div>
                  <div className="font-semibold text-gray-900">Ayu Ningrum</div>
                  <div className="text-sm text-gray-600">Mahasiswa UGM</div>
                </div>
              </div>
            </div>
          </div>
